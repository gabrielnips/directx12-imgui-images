...
namespace Dx12Utils
{
        ...
        D3D12_SUBRESOURCE_DATA* pSrcData)
    {
        ...
        pDevice->GetCopyableFootprints(&DestDesc, FirstSubresource, NumSubresources, IntermediateOffset, Layouts.data(), NumRows.data(), RowSizesInBytes.data(), &RequiredSize);
        ...
        BYTE* pDest = reinterpret_cast<BYTE*>(pData);
